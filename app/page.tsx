...
export default function QuinceaneraInvitation() {
  ...
  const scenesWithCustomTiming = [0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11] // TitleScene, MessageScene1, MessageScene2, NameScene, MessageScene3, ParentsScene, ReceptionScene, ScheduleScene
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {currentScene === 9 && <GalleryScene onComplete={handleSceneComplete} isActive={!isPaused} />}
